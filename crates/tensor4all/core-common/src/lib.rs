...
pub use index::{DefaultIndex, DynId, Index, NoSymmSpace, Symmetry, TagSet};
pub use index_ops::{
...
pub use tagset::{DefaultTagSet, Tag, TagSet as InlineTagSet, TagSetError, TagSetIterator, TagSetLike};
