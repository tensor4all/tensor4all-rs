...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::sim_owned;
///
/// let idx = Index::new_dyn(8);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::check_unique_indices;
///
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::replaceinds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::replaceinds_in_place;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::unique_inds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::noncommon_inds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::union_inds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::hasind;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let indices = vec![i.clone(), j.clone()];
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::hasinds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
...
/// ```
/// use tensor4all_core_common::index::{DefaultIndex as Index, DynId};
/// use tensor4all_core_common::index_ops::hascommoninds;
///
/// let i = Index::new_dyn(2);
/// let j = Index::new_dyn(3);
/// let k = Index::new_dyn(4);
