...
fn create_simple_mps_chain() -> (
    ...
    let t1 = TensorDynLen::new(
        ...
        vec![4, 2, 4],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(vec![1.0; 32], &[4, 2, 4]))),
    );
    ...
    let t2 = TensorDynLen::new(
        ...
        vec![4, 2],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(vec![1.0; 8], &[4, 2]))),
    );
...
fn create_two_site_mps() -> (
    ...
    let t0 = TensorDynLen::new(
        vec![s0.clone(), b01.clone()],
        vec![2, 2],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(vec![
...
fn create_diagonal_mpo(
    ...
    let t0 = TensorDynLen::new(
        ...
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data0, &[phys_dim, phys_dim, 1]))),
    );
    ...
    let t1 = TensorDynLen::new(
        ...
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data1, &[1, phys_dim, phys_dim]))),
    );
...
fn create_mps_from_values(
    ...
    let t0 = TensorDynLen::new(
        ...
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data0, &[phys_dim, bond_dim]))),
    );
...
fn create_three_site_mps(
    ...
    let t1 = TensorDynLen::new(
        ...
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data1, &[bond_dim, phys_dim, bond_dim]))),
    );
    ...
    let t2 = TensorDynLen::new(
        vec![b12.clone(), s2.clone()],
        vec![bond_dim, phys_dim],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data2, &[bond_dim, phys_dim]))),
    );
...
fn create_three_site_identity_mpo(
    ...
    let t1 = TensorDynLen::new(
        ...
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data1, &[1, phys_dim, phys_dim, 1]))),
    );
    ...
    let t2 = TensorDynLen::new(
        ...
        vec![1, phys_dim, phys_dim],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(data2, &[1, phys_dim, phys_dim]))),
    );
...
fn test_linear_operator_apply_local() {
    ...
    let local_v = TensorDynLen::new(
        ...
        vec![phys_dim],
        Arc::new(Storage::DenseF64(DenseStorageF64::from_vec_with_shape(vec![1.0, 0.0], &[phys_dim]))),
    );
