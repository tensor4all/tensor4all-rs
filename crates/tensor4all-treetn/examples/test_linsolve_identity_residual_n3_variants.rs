...
//!   - bond_dim=1 (residual decreases): init=rhs
//!   - bond_dim=2 (residual does not decrease): init=rhs
//!
...
fn run_test_case(a0: f64, a1: f64, init_mode: &str, bond_dim: usize) -> anyhow::Result<()> {
    ...
    // init selection
    // For random initialization, allow independent bond dimension up to 100
    let init_bond_dim = 100usize;
...
fn main() -> anyhow::Result<()> {
    ...
    // Test case 2: init=rhs
    println!("Test 2: init=rhs");
