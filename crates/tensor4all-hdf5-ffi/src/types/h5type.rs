...
use crate::types::array::VarLenArray;
use crate::types::string::{FixedAscii, FixedUnicode, VarLenAscii, VarLenUnicode};
...
pub mod tests {
    ...
    #[test]
    #[ignore = "Uses unsafe null pointer dereference pattern that may fail"]
    pub fn test_tuples() {
        type T1 = (u16,);
