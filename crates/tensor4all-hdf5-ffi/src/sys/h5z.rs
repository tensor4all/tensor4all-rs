...
//!
//! Types and constants for HDF5 filter operations.
...
pub use H5Z_EDC_t::*;
pub use H5Z_SO_scale_type_t::*;
pub use H5Z_cb_return_t::*;
...
/// Scale type for scale-offset filter
#[repr(C)]
...
pub type H5Z_class_t = H5Z_class2_t;
