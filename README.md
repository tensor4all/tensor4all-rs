...
- **Partitioned TreeTNs**: Eagerly masked subdomains, volume-budgeted adaptive patching, reconstruction with a fixed global L2 tolerance, and level-coupled merge-refine QFT scheduling
